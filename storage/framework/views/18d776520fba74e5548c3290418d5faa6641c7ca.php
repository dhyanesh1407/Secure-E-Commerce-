...
} elseif ($_instance->childHasBeenRendered('mUuRIXa')) {
    $componentId = $_instance->getRenderedChildComponentId('mUuRIXa');
    $componentTag = $_instance->getRenderedChildComponentTagName('mUuRIXa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mUuRIXa');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('mUuRIXa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
